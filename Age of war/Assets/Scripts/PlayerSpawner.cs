...
{
    // Créez une copie temporaire de la liste
    List<GameObject> playersCopy = new List<GameObject>(activePlayers);

    // Utilisez une boucle for pour éviter la modification de la liste pendant l'itération
